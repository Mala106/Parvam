...
# Build an absolute path so SQLite creates users.db in the day3 project folder.
BASE_DIR = Path(__file__).resolve().parent
DATABASE_PATH = BASE_DIR / "users.db"

# This tells Flask-SQLAlchemy exactly where the SQLite database file should live.
